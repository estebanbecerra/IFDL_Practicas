...
# Cargar configuración de DeepSpeed
...
output_file = os.path.join(output_dir, "squeezenet_train_gpu_deepspeed_results.txt")

# Iniciar profiler como en Accelerate
with profile(
...
# Guardar resultados con tabla tipo Accelerate
