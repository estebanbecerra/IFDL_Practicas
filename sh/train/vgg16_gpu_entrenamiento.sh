...
#SBATCH --job-name=vgg16_gpu # Nombre del job
#SBATCH --output=/home/estebanbecerraf/outputs/train/vgg16_gpu_%j.log # Archivo de salida
...
apptainer exec --writable-tmpfs --nv /software/singularity/Informatica/mia-idl-apptainer/mia_idl_2.1.sif \
    ...
    /home/estebanbecerraf/scripts/train/entrenamiento_vgg16_gpu.py