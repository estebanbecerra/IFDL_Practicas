...
#SBATCH --job-name=efficientnet_cpu # Nombre del job
#SBATCH --output=../../outputs/inference/efficientnet_cpu_%j.log # Archivo de salida
...
apptainer exec --writable-tmpfs --nv /software/singularity/Informatica/mia-idl-apptainer/mia_idl_2.1.sif \
    ...
    ../../scripts/inference/inferencia_efficientnet_cpu.py
